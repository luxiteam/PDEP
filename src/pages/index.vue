                ...
                <div class="logo_box">
                    ...
                    <form action="#" name="f" method="post" id='form'>
                        <div class="input_outer">
                            ...
                            <el-input name="account" class="text" id='user' style="color: #FFFFFF !important" type="text" placeholder="请输入账户"/>

                       
                        </div>
                        <div class="input_outer">
                            <span class="us_uer"></span>
                            <el-input name="password" class="text" id='password' style="color: #FFFFFF !important; position:absolute; z-index:100;" value="" type="password" placeholder="请输入密码"/>
                        </div>
